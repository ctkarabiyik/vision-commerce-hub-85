        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              High-resolution sensors designed for quality inspection, measurement, and machine vision applications. 
              Our area scan cameras deliver exceptional image quality with frame rates up to 500 fps.
            </p>
          </div>
        </div>
      </section>
...
export default AreaScanCameras;
