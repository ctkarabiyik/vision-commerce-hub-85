...
const products = [
  ...
  },
  {
    ...
    specs: [
      { label: "Sensor", value: "2/3\"" },
      { label: "Mount", value: "C-Mount" },
      { label: "Grade", value: "Budget" },
    ],
    category: "fa-lenses",
